...
Use the [interactive tool picker](https://shaunmarsden.github.io/sibling-projects/) for these decisions. Each outcome is a clickable card that opens the relevant skill.

If neither card fits, say so plainly rather than forcing the closest match. Suggest a new tool in a [sibling-projects discussion](https://github.com/shaunmarsden/sibling-projects/discussions).
